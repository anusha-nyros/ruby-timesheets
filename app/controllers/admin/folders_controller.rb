class Admin::FoldersController < Admin::AdminController
 #layout 'app'
  # GET /folders
  # GET /folders.json
  def index
  ...
  def create
    ...
    respond_to do |format|
      if @folder.save
        format.html { redirect_to admin_folders_path, notice: 'Folder was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @folder.update_attributes(params[:folder])
        format.html { redirect_to admin_folders_path, notice: 'Folder was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_folders_url }
      format.json { head :no_content }
    end
  end
