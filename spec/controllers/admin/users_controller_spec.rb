...
describe Admin::UsersController do
  ...
  describe "GET index" do
    it "assigns all user that associated with user's organization" do
      user = Factory(:user, organization: @admin.organization)
  ...
  describe "POST 'create" do
    before(:each) do
      post :create, user: { username: 'new_user', name: 'user2', group: 'users', password: 'secret', password_confirmation: 'secret', email: 'user@test.com', admin: 1}      
    end
  ...
  describe "PUT 'update'" do
    ...
    it "should update admin status" do
        admin = Factory(:admin, organization: @admin.organization)
        admin.admin = false
