    ...
    describe "user active" do      
      describe "ordinary user" do
        ...
        it "should display user not active and re render new " do
          @user = Factory(:user, username: @username, password: @password, password_confirmation: @password, active: false)
          post 'create', { username: @username, password: @password }
      ...
      describe "admin" do
        it "should redirect to admin root path" do
          @user = Factory(:admin, username: @username, password: @password, password_confirmation: @password)
          post 'create', { username: @username, password: @password }
          assigns(:user).should eq(@user)
